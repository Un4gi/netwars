...
$WatchFolder = "C:\FTPServer\tokens" # Change this directory as necessary
$Files = (Get-ChildItem $WatchFolder).FullName
if ($Files) {
    Remove-Item $Files
    New-Item -Path "C:\FTPServer\tokens" -Name "NetWars{R25TY5}" -ItemType "file" -Value "NetWars{R25TY5}" # Change the file name as necessary. Value should not matter for Netwars purposes.
